classdef ReservoirTanhB_WMproj < handle
    properties
        % Matrices
    ...
    methods
        % Constructor
        function obj = ReservoirTanhB_WMproj(baseRNN)
            % Matrices
            obj.A = baseRNN.A;
            obj.B = baseRNN.B;
            ...
            obj.rs = baseRNN.rst;
            obj.xs = baseRNN.xst;
            obj.d  = atanh(obj.rs) - obj.A*obj.rs - obj.B*obj.xs;

            % Time
            obj.delT = baseRNN.dt;
            obj.gam  = baseRNN.gamma;

            % Initialize reservoir states to 0
            obj.r = zeros(baseRNN.n,1);
        end
